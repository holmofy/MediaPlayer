...
//    private static final int MSG_CHECK_BLOCK = 0x0003;
    ...
    private void refreshUI() {
        ...
        if (isVideoPrepared) {
            //设置播放进度
            mediaCurrTimeSeekbar.setProgress((int) videoView.getCurrentPosition());
            //设置缓冲进度
            int secondProgress = (int) (videoView.getBufferPercentage() * videoView.getDuration() / 100);
        ...
        //设置当前网速
        String speed = NetSpeedUtil.getCurrentNetSpeed(VitamioPlayerActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.activity_vitamio_player);
    ...
    private void findView() {
        ...
        //加载数据前，先设置蒙版掩盖控件
        mediaLoadingMask.setBackgroundResource(R.drawable.media_mask);
    ...
    private void initViewData() {
        ...
        if (dataUri != null) {
            if (tvItem != null) {
                mediaName.setText(tvItem.getName());
            } else {
    ...
    private class VideoStateListener implements MediaPlayer.OnPreparedListener, MediaPlayer.OnErrorListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnInfoListener {
        ...
        public boolean onError(MediaPlayer mp, int what, int extra) {
            Toast.makeText(VitamioPlayerActivity.this, "视频数据读取失败", Toast.LENGTH_SHORT).show();
            closePlayer();
            return true;
        }
    ...
    private void loadMediaInfo() {
        //设置播放进度条
        mediaCurrTimeSeekbar.setMax((int) videoView.getDuration());
